...
if ($arParams['bAdmin'] && $USER->IsAuthorized()):
    ...
    <span class="webform-small-button"
          onclick="BX.AbsenceCalendar.ExportExcel(<?=CUtil::PhpToJSObject($arResult['ELEMENTS_TO_EXPORT'])?>)">
		<span class="webform-small-button-icon"></span>
		<span class="webform-small-button-text"><?=GetMessage('EXPORT_EXCEL')?></span>
	</span>
<!--	<span class="webform-small-button webform-small-button-blue webform-small-button-add"-->
<!--	   onclick="--><?php //="BX.AbsenceCalendar.ShowForm(".CUtil::PhpToJSObject($arAbsenceParams).")"?><!--">-->
<!--		<span class="webform-small-button-icon"></span>-->
<!--		<span class="webform-small-button-text">--><?php //=GetMessage('INTR_ABSC_TPL_ADD_ENTRY')?><!--</span>-->
<!--	</span>-->
	<?
	$this->EndViewTarget();
endif;
